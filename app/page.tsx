      ...
      <section id="reviews" className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="p-6 pt-0">
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <input className="border rounded-xl p-3" name="email" placeholder="Email (not published)" type="email" required />
                </div>
          ...
          <div className="flex flex-wrap gap-3">
            <a href={GOOGLE_REVIEW_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-2xl px-5 py-3 border border-blue-700 text-blue-700 font-medium hover:bg-blue-50 transition">
              Review on Google
            </a>
            <a href={FACEBOOK_REVIEW_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-2xl px-5 py-3 border border-blue-700 text-blue-700 font-medium hover:bg-blue-50 transition">
              Review on Facebook
            </a>
          </div>
        </div>
